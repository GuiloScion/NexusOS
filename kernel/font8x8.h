 ...
 *
 * Public-domain font8x8_basic (Marcel Sondaar / Daniel Hepper). Each glyph is
 * 8 bytes, one per row, top to bottom. Within a row byte, bit 0 (LSB) is the
 * leftmost pixel: pixel (col) is set when (row_byte >> col) & 1.
 */
